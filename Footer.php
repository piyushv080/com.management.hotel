...
<footer style="background-color: #393939;">
	...
	<div class="col-sm-4 hov">
		<img src="logo/logo.png"width="150px"height="50px"/><br><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Yashoda Nagar Kanpur</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>piyushv080@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91) 8174812109</p><br><br><br>
     <center><img src="image/devlop/Piyush.jpg"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Developed by @piyush | All Rights Reserved 2020</p>
</footer>
