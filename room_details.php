...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      <img src="image/Delux Room Single Bed Ac Room/img2.jpg"class="thumbnail" alt="img2">
    </div>

    <div class="item">
       <img src="image/Delux Room Single Bed Ac Room/img3.jpg"class="thumbnail" alt="img3">
    </div>
    ...
    <div class="item">
       <img src="image/Delux Room Single Bed Ac Room/img7.jpg"class="thumbnail" alt="img6">
    </div>
  </div>
